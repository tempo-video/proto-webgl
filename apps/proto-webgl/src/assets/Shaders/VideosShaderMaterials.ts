import { VideoTexture, ShaderMaterial, DoubleSide, Vector2 } from "three";

export default RGBEffectShaderMaterial;

function RGBEffectShaderMaterial(texture: VideoTexture) {
